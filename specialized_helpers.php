...
// Fetch top helpers by task specialization
$sql = "
    SELECT 
        h.helper_id, 
        h.name, 
    ...
    ORDER BY tasks_completed DESC, h.rating DESC;
";
...
<head>
    ...
    <title>Top Helpers by Task Specialization - TogetherA+</title>
...
<body>
    ...
    <main>
        <h1 style="text-align: center; margin-bottom: 20px;">Top Helpers by Task Specialization</h1>
        <div class="helper-list">
            <?php if (!empty($helpers)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>No specialized helpers found.</p>
            <?php endif; ?>
        </div>
    </main>
